from clients.courses.courses_client import get_courses_client, CreateCoursesRequestSchema, CreateCourseResponseSchema
...
create_exercise_request = CreateExerciseRequestSchema(
    course_id = created_course_response.course.id
)
created_exercise_response = exercise_client.create_exercise(create_exercise_request)
print('Create exercise data:', created_exercise_response)
